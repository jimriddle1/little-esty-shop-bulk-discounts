...
RSpec.describe "Admin Invoice Show" do
    before :each do
      ...
      @discount1 = @merch1.discounts.create!(bulk_discount: 0.2, item_threshold: 100)
      @discount2 = @merch1.discounts.create!(bulk_discount: 0.3, item_threshold: 200)
    end
    ...
    it "displays total discounted revenue that will be generated by invoice" do
      visit("/admin/invoices/#{@inv1.id}")
      save_and_open_page
      expect(page).to have_content("Total Discounted Revenue: 3600.0")
    end
